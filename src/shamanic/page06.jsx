...
function Dios(e){
     ...
     <div style={ {  overflow:'hidden' } } id="Page04">
        ...
        <div style={{ width: '100%;', maxWidth: '480px;', height: '900px;' }}>

             <iframe 
            title="Sandra"
            style={{ width: '100%', height: '100%', border:0 }}
            src="https://joinnow.live/embed/s/pB6qVh?layout=styled-2"></iframe>
        ...
        { false &&  <div style={{ transition: "all 1.5s 1s ease"}} >
